...
const TUI_OWNED_COMMANDS = new Set(['rewind'])
...
export function apply(ctx, config) {
  ...
  function askQuestions(req) {
    return new Promise((resolve, reject) => {
      ...
      const state = {
        ...
        // Esc: decline to answer here. Delegating lets any other answerer take
        // it; with none, the service rejects with NO_PROVIDER, which is the
        // honest outcome and cannot be mistaken for a human choice.
        defer: () => {
          if (settled) return
          settled = true
          detach()
  ...
  async function runCommand(line) {
    ...
    if (!TUI_OWNED_COMMANDS.has(parsed.name)
