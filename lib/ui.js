...
export class App {
  ...
  render() {
    ...
    else if (this.contextMeterOpen && !this.overlay) this._paintContextPanel(screen, cols, rows)
  ...
  _paintHelp(screen, cols, rows) {
    ...
    yy++
    for (const cmd of ['/help  /settings  /new  /resume <id>', '/model <id>  /provider <route>  /rewind', '/clear  /cancel  /quit']) {
