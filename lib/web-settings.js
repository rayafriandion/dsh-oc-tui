...
// carries the merged provider + model settings, Update carries the in-app
// dsh / dsh-oc-tui version manager. Tab switches the entries.
...
export async function loadWebSettings(ctx) {
  ...
  items.push({ kind: 'open-update', label: 'Update manager', value: 'Update tab', disabled: false })
